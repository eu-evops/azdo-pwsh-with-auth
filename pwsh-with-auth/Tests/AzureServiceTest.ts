...
process.env.ENDPOINT_AUTH_PARAMETER_azdo_TENANTID="TenantId"
process.env.ENDPOINT_AUTH_PARAMETER_azdo_SERVICEPRINCIPALID="ServicePrincipalId"
process.env.ENDPOINT_AUTH_PARAMETER_azdo_AUTHENTICATIONTYPE="AuthenticationType"
process.env.ENDPOINT_AUTH_PARAMETER_azdo_SERVICEPRINCIPALKEY="ServicePrincipalKey"
